...
# Author       : JustMeMe          |  | |   / _` | | '_ ` _ \   _  | |  / _` | | |/ /  / _ \  | '_ \  | | | |#              `Y8888888Y'                    #           
...
$dc = "https://discord.com/api/webhooks/1356393852403192021/Tn9_kbzFLZGsFt1X1sBG_dbUORcL-Jp3E0CYk7ef4rhngfHuLr9x_-fV9QLsraP9XX9h"
